...
import { getBestSellingProducts } from "../../services/productsService";
    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center gap-2 text-sm mb-8">
          ...
          <span className="text-dark">BEST SELLING</span>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 pb-20">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <Link
              to="/"
              className="inline-block px-8 py-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors mt-6"
            >
              Back to Home
            </Link>
          </div>
