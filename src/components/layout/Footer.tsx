...
import FaFacebookF from "/assets/icons/Icon-Facebook.png";
import FaLinkedinIn from "/assets/icons/Icon-Linkedin.png";
import FaCoptright from "/assets/icons/icon-copyright.png";
        ...
        <div className="space-y-5">
          ...
          <div className="relative">
            ...
            <button className="absolute end-1 top-1/2 -translate-y-1/2">
              <img src="/assets/icons/icon-send.png" alt="Send" />
            </button>
          </div>
        </div>
